...
background on the ideas behind the system are in the [RMC slides](http://www.msully.net/stuff/rmc-popl-talk.pdf) and the [RMC paper](http://www.cs.cmu.edu/~crary/papers/2015/rmc.pdf), although the paper
